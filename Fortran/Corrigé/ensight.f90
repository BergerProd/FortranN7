SUBROUTINE write_result_ensight(xEnsight,yEnsight,u,v,omega,press,temp,div,nx,ny,nz,istep1,isto,nstep,nstep_fin,t,dt)
   ...
   integer :: nx,ny,nz,istep1,isto,nstep,nstep_fin
   real*8 :: t,dt
   ...
   call EnsightCase(nbVar,varName,caseName,VarType,nstep_fin,istep1,nstep,isto,t,dt)
