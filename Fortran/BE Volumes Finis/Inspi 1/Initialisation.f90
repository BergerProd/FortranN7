...
!***************************************************************!
!	Variables Generales pour le Solveur Navier-Stokes/temperature			!
!***************************************************************!

	integer, parameter :: nx  =  60   !nombre de cellules de calcul en x
	integer, parameter :: ny  =  20    !nombre de cellules de calcul en y
	...
	integer, parameter :: isto   =  600  !frequence de stockage de la solution ( tous les isto pas de temps)

	integer, parameter :: reprise = 0     !indicateur de reprise de calcul : 0 on part de t=0, 1 on lit un fichier de reprise

	real*8 , parameter :: tmax = 1.       ! temps maxi de simulation

	real*8 , parameter :: cfl     =  0.95 ! condition de stabilité pour l'intégration en temps des eqts de Navier-Stokes
	real*8 , parameter :: R     =  0.5   ! condition de stabilité pour l'intégration en temps des eqts de temperature
...
!***************************************************************!
	...
	real*8 , parameter :: xmax  =   0.15   !en m

	real*8 , parameter :: ymin  =  0.   !en m
	real*8 , parameter :: ymax  =  0.05   !en m
	...
	real*8 , parameter :: temp_bas =  305.   !température de reference du fluide  en K
  	real*8 , parameter :: kappa    =  0.000026    !coefficient de diffusivite thermique du fluide
  	real*8 , parameter :: alpha    =  0.0001  !coefficient de dilatation thermique en kg/m^3/K
